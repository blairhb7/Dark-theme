    ...
    <main className=' flex flex-col  w-full  bg-[#000000] text-white '>
            ...
            <section className=" mx-6 md:px-0 grid ">
                <div className=" w-full flex flex-col">
                    ...
                    <h1 className=' text-2xl md:text-5xl uppercase'>About</h1>
                        ...
                        Fast-forward to today, I've been diving into more complex technologies like <span className=' font-bold text-white'>Email Devlopment,</span> <span className=' font-bold text-white'>React,</span> <span className='font-bold text-white'>Next-js,</span> <span className='text-white font-bold'>Tailwind,</span>  and <span className=' font-bold text-white'>Typescript.</span> As this field continues to change, I am always still learning. 
        ...
        <section className="grid grid-cols-1 col-span-2 pt-12 md:pt-20">
            <div className=" ">
                ...
                <div className="[--duration:60s]  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 h-full max-h-full p-8 md:px-20 gap-2">
                    {
